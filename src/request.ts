...
export interface Request {
  (url: string | URL, options: RequestOptions<any> & { returnState: true }): Promise<RequestState<any, ClientRequest, IncomingMessage>>
  <T>(url: string | URL, options: RequestOptions<T> & { returnState: true }): Promise<RequestState<T, ClientRequest, IncomingMessage>>
  (url: string | URL, options?: RequestOptions<any>): Promise<any>
  <T>(url: string | URL, options?: RequestOptions<T>): Promise<T>
}
